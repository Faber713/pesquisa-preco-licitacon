...
|---|---:|---|
| `licitacon.sqlite` | 6.02 GB | Banco bruto/consolidado legado, hoje movido para RAW |
...
- Flask ainda mantem fallback para este banco via `LICITACON_SQLITE_PATH`.
...
- `build/`: nenhum impacto no Flask; afeta apenas empacotamento antigo.
